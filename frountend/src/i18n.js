...
const resources = {
  ...
  Hindi: {
    translation: {
      ...
      "areYouSure": "क्या आप वाकई अपना खाता हटाना चाहते हैं? इस कार्रवाई को पूर्ववत नहीं किया जा सकता।",
  ...
  Spanish: {
    translation: {
      ...
      "areYouSure": "¿Estás seguro de que quieres eliminar tu cuenta? Esta acción no se puede deshacer.",
  ...
  French: {
    translation: {
      ...
      "areYouSure": "Êtes-vous sûr de vouloir supprimer votre compte ? Cette action ne peut pas être annulée.",
