      ...
      <div className="offline-content">
        <div className="earth-container">
          ...
          >
            ...
            />
            <path
              d="M 50 5 C 70 5 85 20 90 40 C 92 48 90 60 80 70 C 65 85 45 95 30 85 C 15 75 5 55 10 40 C 15 20 30 5 50 5 Z"
              fill="rgba(56, 189, 248, 0.2)"
            />
            <path
              d="M 30 20 Q 40 10 50 30 T 70 40 T 60 70 T 30 60 Z"
              fill="#38bdf8"
            />
